...
import Logo from "./Media/RMLogo.png"

export default function Header() {
    return (
        <header>
            <div className="bg-blue-100 p-4 sm:flex sm:items-center sm:justify-between px-6">
                    <span className="text-sm text-blue-500 sm:text-center dark:text-gray-400"> <a href="https://internationalsportsmedia" className="hover:underline">Contact Us</a></span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0 ">
                        ...
                        <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white pr-1">
            ...
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-white-800 ">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <a href="#" className="flex items-center">
                        <Image src={Logo} className="w-auto h-35" alt="RMLogo"/>
                    </a>
                    <div className="flex items-center lg:order-2">
                        <a href="#" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Download Remin App</a>
                    ...
                    <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <li>
                                <a href="#" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Match Center</a>
                            </li>
                            <li>
