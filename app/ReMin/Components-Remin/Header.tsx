    ...
    <header className="sticky top-0 z-50">
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-4 dark:bg-white-800">
        <div className="flex flex-wrap justify-between items-center mx-auto">
          ...
          {/* Menú desplegable */}
          <div
            className={`lg:flex lg:w-auto lg:order-1 absolute ${
              isMenuOpen ? "top-20 right-0 mr-6" : "top-12 right-0 mr-6"
            } bg-white lg:bg-transparent lg:h-auto lg:block ${
              isMenuOpen ? "border-2 border-purple-500" : ""
              ...
              {[
                {
                  ...
                  name: "HOME",
                  className:
                    "text-black border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-violet-500 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700",
                  openInNewTab: false,
                },
                {
                  href: process.env.NEXT_PUBLIC_CONTEST_URL || "",
                  name: "ROAD TO THE BERNABEU",
                  className:
                    "text-black border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-violet-500 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700",
                  openInNewTab: true,
                },
                ...
                <li key={link.name}>
                  <CustomLink
                    ...
                    target={link.openInNewTab ? "_blank" : "_self"} // Condicional para abrir en nueva pestaña
                  >
                    {link.name}
                  </CustomLink>
                </li>
