            ...
            <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
                <div className="mx-auto max-w-screen-xl">
                    <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            <a href="#top" className="flex items-center">
                                <Image src="/intfanmedia.jpeg" width={40} height={40} alt="biglogo" />
                            </a>
                        </div>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://www.internationalfansmedia.com" target="_blank" rel="noopener noreferrer" className="hover:underline">International Fan Media</a>. All Rights Reserved.
                        </span>
