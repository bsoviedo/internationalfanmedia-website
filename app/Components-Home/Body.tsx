...
export default function Body() {
    ...
    return (
        <main className='h-screen bg-slate-900 flex flex-col justify-start items-center pt-20' id="Teams">
            ...
            <ul className="space-y-10 w-4/5 animate-fade animate-once animate-delay-500 animate-ease-in">
                ...
                <li className="mx-auto max-w-screen-xl px-4 lg:px-0 pt-2">
                    <Link href="/Barcelona" target="_blank" rel="noopener noreferrer">
                        <button className="shadow-xl font-bold text-white w-full h-60 text-lg lg:text-3xl py-10 px-6 rounded-xl flex items-center bg-gradient-to-l from-blue-700 via-violet-600 to-red-700 hover:bg-orange-600 hover:scale-110">
