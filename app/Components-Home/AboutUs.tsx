...
export default function AboutUs() {
    ...
    return (
     <div className="bg-slate-900 dark:bg-gray-900 ">
        <div className=" h-screen py-8 px-4 mx-auto max-w-screen-xl lg:py-16  lg:px-6 ">
            <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                ...
                <p className="font-light text-white lg:mb-16 sm:text-xl dark:text-gray-400">International Fan Media Description</p>
            </div> 
            <div className="grid gap-8 mb-6 lg:mb-16 md:grid-rows-2">
                <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="p-5">
                        ...
                        <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Description will go here </p>
                ...
                <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="/Picture2.png" alt="Jese Avatar"/>
                    </a>
                    <div className="p-5">
                        <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="#">Jordan Lorenzo</a>
                        </h3>
                        <span className="text-gray-500 dark:text-gray-400">CCO & DME</span>
                        <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Description will go here.</p>
                        <ul className="flex space-x-4 sm:mt-0">
                            <li>
                                <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
